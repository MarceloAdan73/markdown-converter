...
![Markdown Converter](https://raw.githubusercontent.com/MarceloAdan73/markdown-converter/main/screen1.png)

| Desktop View | Mobile View | Dark Mode |
|--------------|-------------|-----------|
| ![Desktop](https://raw.githubusercontent.com/MarceloAdan73/markdown-converter/main/screen1.png) | *Coming soon* | *Coming soon* |
...
|------------|---------|---------|
| ![React](https://img.shields.io/badge/React-18.3.1-61DAFB?style=flat-square&logo=react) | UI Framework | 18.3.1 |
| ![TypeScript](https://img.shields.io/badge/TypeScript-4.9.5-3178C6?style=flat-square&logo=typescript) | Type Safety | 4.9.5 |
| ![Electron](https://img.shields.io/badge/Electron-27.3.11-47848F?style=flat-square&logo=electron) | Desktop Runtime | 27.3.11 |
| ![Create React App](https://img.shields.io/badge/CRA-5.0.1-09D3AC?style=flat-square&logo=create-react-app) | Build Tooling | 5.0.1 |

### **PWA & Optimization**
| Technology | Purpose | Version |
|------------|---------|---------|
| ![Workbox](https://img.shields.io/badge/Workbox-7.4.0-4285F4?style=flat-square&logo=google) | Service Workers | 7.4.0 |
| ![PWA](https://img.shields.io/badge/PWA-Native-5A0FC8?style=flat-square&logo=pwa) | Progressive Web App | Native |
| ![CSS3](https://img.shields.io/badge/Custom_CSS-4232_lines-1572B6?style=flat-square&logo=css3) | Styling System | 4,232 lines |

### **Development Tools**
| Technology | Purpose |
|------------|---------|
| ![Concurrently](https://img.shields.io/badge/Concurrently-8.2.2-blue?style=flat-square) | Parallel Process Management |
| ![Wait-on](https://img.shields.io/badge/Wait--on-7.2.0-green?style=flat-square) | Service Dependency Management |
| ![Cross-env](https://img.shields.io/badge/Cross--env-7.0.3-yellow?style=flat-square) | Cross-platform Environment Variables |
